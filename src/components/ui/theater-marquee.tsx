...
export const TheaterMarquee = () => {
  ...
  return (
    <div className="relative bg-primary border-y-2 border-secondary overflow-hidden">
      ...
      <div className="absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-primary via-primary to-transparent z-10 flex items-center justify-center">
        <Star className="w-4 h-4 text-secondary fill-secondary" />
      </div>
