                    ...
                    {isUsingDemo ? (
                      ...
                      >
                        <div className="flex items-start justify-between mb-4">
                          <div className="w-16 h-16 bg-primary/10 flex items-center justify-center rounded-xl overflow-hidden border-2 border-secondary/30 transition-all duration-200 group-hover:scale-105 group-hover:border-secondary/50 shadow-sm">
                            {group.logo ? (
                              <img 
                                src={group.logo} 
