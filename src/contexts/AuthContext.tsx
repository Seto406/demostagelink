  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && (window as any).PlaywrightTest) {
        ...
        if (mockUser) {
            ...
            // Check for injected profile
            const injectedProfile = (window as any).PlaywrightProfile;

            if (injectedProfile) {
                console.log("Injecting Playwright Mock Profile", injectedProfile);
                setProfile(injectedProfile as unknown as Profile);
            } else {
