...
## 2025-05-24 - Interactive Hover States Accessibility
...
**Action:** Always add `focus-visible:opacity-100` to interactive elements that are visually hidden until hovered.
