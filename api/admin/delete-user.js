...
export default async function handler(req, res) {
  ...
  if (!supabaseUrl || !supabaseAnonKey || !serviceRoleKey || !adminActionKey) {
  ...
  const { user_id: userId, profile_id: profileId, security_key: securityKey } = req.body ?? {};

  if (!securityKey || securityKey !== adminActionKey) {
