-- Add trailer field for shows (idempotent)
ALTER TABLE public.shows
ADD COLUMN IF NOT EXISTS video_url TEXT;

-- Governance guardrail: limit media attachments per post
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1
    ...
    CHECK (media_urls IS NULL OR cardinality(media_urls) <= 4);
  END IF;
END
$$;

-- Ensure edit request approval applies trailer updates too
...
BEGIN
    ...
    SET
        ...
        video_url = COALESCE(p.video_url, s.video_url),
